...
const reviewSummaryMessage = "This backend example shows how a runtime plugin can organize Go APIs before phase-3 runtime execution is implemented."

// ReviewSummaryOutput defines one review-only runtime backend summary.
