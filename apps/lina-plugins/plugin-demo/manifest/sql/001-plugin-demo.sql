...
VALUES (0, 'plugin:plugin-demo:sidebar-entry', '插件示例', 'plugin-demo-sidebar-entry', 'system/plugin/dynamic-page', 'plugin-demo:example:view', 'ant-design:appstore-outlined', 'M', -1, 1, 1, 0, 0, '', '插件示例左侧菜单', NOW(), NOW());
