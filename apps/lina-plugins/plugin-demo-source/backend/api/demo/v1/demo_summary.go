...
type SummaryReq struct {
	g.Meta `path:"/plugins/plugin-demo-source/summary" method:"get" tags:"源码插件示例" summary:"查询源码插件示例摘要" dc:"返回 plugin-demo-source 页面展示所需的简要介绍文案，用于验证源码插件菜单页可读取插件后端接口数据"`
}
