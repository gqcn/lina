...
// validatePluginManifestSemanticVersion validates semantic version strings used by plugin.yaml.
func validatePluginManifestSemanticVersion(value string) error {
