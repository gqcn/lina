...
type UsersReq struct {
	g.Meta  `path:"/dept/{id}/users" method:"get" tags:"部门管理" summary:"获取部门用户列表" dc:"获取指定部门及其所有子部门下的用户列表，主要用于选择部门负责人等场景。当部门ID为0时返回所有用户，支持按用户名或昵称进行关键词搜索" permission:"system:dept:query"`
