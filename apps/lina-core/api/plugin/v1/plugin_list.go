...
type PluginItem struct {
	...
	Entry       string `json:"entry" dc:"插件入口描述，可为路由、文件或模块标识" eg:"backend:plugins/{id}/resources/login-audits"`
	Description string `json:"description" dc:"插件描述" eg:"提供登录审计查询能力的示例插件"`
