...
type InstallReq struct {
	g.Meta        `path:"/plugins/{id}/install" method:"post" tags:"插件管理" summary:"安装动态插件" dc:"执行动态插件的安装生命周期，包括运行插件声明的安装SQL并将插件状态更新为已安装；若插件声明了资源型 hostServices（如 storage.resources.paths、network 的 URL 模式或 data.resources.tables），则本次请求同时提交宿主确认后的授权结果"`
